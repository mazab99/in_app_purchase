...
import 'package:in_app_purchase_app/app/core/services/in_app_purchase.service.dart';
import 'package:in_app_purchase_app/app/core/states/payment.state.dart';
    ...
    Future<void> executePurchase() async {
      if (purchaseStatus != PaymentPurchaseStatus.pending) {
        if (productDetail.value != null) {
          await ref.read(inAppPurchaseServiceprovider).purchaseMethod(product, productDetail.value!);
        }
      }
      return;
    }
